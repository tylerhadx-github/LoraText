  ...
  <section id="top" class="hero" ref="root">
    ...
    <div class="hero__inner">
      <p class="hero__eyebrow" ref="eyebrow">
        <span class="hero__dot"></span> Off-grid · encrypted · no cell service
      </p>

      <h1 class="hero__headline">
        <span class="line"><span class="line__inner">Text anywhere,</span></span>
        <span class="line"><span class="line__inner">even with <em>no signal</em>.</span></span>
      </h1>

      <p class="hero__intro" ref="intro">
        LoraText pairs to a custom LoRa radio over Web Bluetooth and sends
        pre-shared-key encrypted messages with zero cell service. Off-grid is the
        whole point - text your group, drop pins, and share live location on a map.
      </p>
      ...
      <div class="hero__cta" ref="cta">
        ...
        <a href="#how" class="btn btn--ghost" @click="scrollTo($event, '#how')">
          How it works
        </a>
      </div>
    ...
    <a href="#how" class="hero__scroll" @click="scrollTo($event, '#how')" aria-label="Scroll to how it works">
...
<script setup>
  ...
  const hints = [
    'No cell tower', 'Pre-shared-key encrypted', 'Web Bluetooth pairing',
    'Live group map', 'Installable PWA', 'Open source kit',
  ]
